    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8 p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300">Join our learning community</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            {['username', 'email', 'password', 'skills_offered', 'skills_needed'].map((field) => (
              <div key={field}>
                <label htmlFor={field} className="text-sm font-medium text-gray-700 dark:text-gray-300 capitalize">
                  {field.replace('_', ' ')}
                </label>
                <input
